  ...
  render() {
    return (
              ...
              >
                  ...
                  <div className="control">
                    <div className="select is-fullwidth">
                      ...
                      >
                        ...
                        <option value="Prescription Drug Plans">Prescription Drug Plans</option>
                      </select>
                    </div>
                  </div>
                </div>
                <div className="field">
                  ...
                  <div className="control">
                    <div className="select is-fullwidth">
                      ...
                      >
                <option value="" disabled selected hidden>Select Option</option>
                <option value="Additional No Cost Benefits">Additional No Cost Benefits</option>
                <option value="Medicare Part A &amp; B">Medicare Part A &amp; B</option>
                <option value="Dental, Vision and Hearing Benefits">Dental, Vision and Hearing Benefits</option>
                <option value="Medicare Plans for those on ACCCHS">Medicare Plans for those on ACCCHS</option>
                ...
                <p className="disclaimer"><em>{'*As a result of completing this form, a sales agent may mail, call or email you to discuss Medicare Advantage, Prescription Drug Plans or Medicare Supplement Insurance.'}</em></p>
